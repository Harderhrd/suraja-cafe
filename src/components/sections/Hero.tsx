...
export default function Hero() {
  ...
  return (
    <section
      className="relative flex min-h-[40vh] items-start justify-center overflow-hidden pb-12 pt-24 md:min-h-[32vh] md:items-center md:pb-10 md:pt-20 lg:min-h-[24vh]"
      aria-label="Hero"
    >
